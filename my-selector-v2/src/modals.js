...
export const openTagModal = (options) => {
    ...
    const content = `
        <div class="flex flex-col h-[70vh]">
            ...
            <div id="tag-list" class="flex-grow min-h-0 overflow-y-auto p-2 bg-gray-900/60 rounded-lg gap-2 grid grid-cols-1 md:grid-cols-2 content-start"></div>
